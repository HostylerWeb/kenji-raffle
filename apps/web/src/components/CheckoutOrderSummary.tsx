    ...
    <div className="site-card">
      ...
      {loading || !cart ? (
        <div className="site-checkout-summary-skeleton" aria-hidden>
          <div className="site-skeleton" style={{ height: 56, marginBottom: 12 }} />
          <div className="site-skeleton" style={{ height: 56, marginBottom: 12 }} />
          <div className="site-skeleton" style={{ height: 28, width: "60%" }} />
        </div>
      ) : cart.items.length > 0 ? (
        <>
      ...
      <hr style={{ border: "none", borderTop: "1px solid var(--site-border)", margin: "20px 0" }} />
      <h2 className="site-section-title">Secure checkout</h2>
      <p className="site-muted" style={{ lineHeight: 1.6 }}>
      ...
      <ul className="site-muted" style={{ paddingLeft: 18, lineHeight: 1.8, fontSize: 14 }}>
